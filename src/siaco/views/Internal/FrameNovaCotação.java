 ...
 * @author Tiago
 */
public class FrameNovaCotação extends javax.swing.JFrame {

    /**
     * Creates new form FrameNovaCotação
     */
    public FrameNovaCotação() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameNovaCotação.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameNovaCotação().setVisible(true);
            }
        });
    }
